{
  description = "nixcluster downstream cluster";
  ...
  outputs = inputs@{ flake-parts, import-tree, nixcluster, ... }:
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      imports = [
        ...
        # Auto-import everything under ./modules (nodes/clusters/clusterModules).
        (import-tree ./modules)
      ];
    };
}
